            ...
            <div id="main-nav-tb" class="container backdrop">
                <div class="row" id="main-nav-links">
                    <a class="col" href="#about">
                        ...
                        <span><?= $data['nav']['about'] ?></span>
                    </a>
                    <a class="col" href="#skills">
                        <i class="lni lni-brush"></i>
                        <span><?= $data['nav']['skills'] ?></span>
                    </a>
                    <a class="col" href="#experience">
                        <i class="lni lni-network"></i>
                        <span><?= $data['nav']['experience'] ?></span>
                    </a>
                    <a class="col" href="#services">
                        <i class="lni lni-briefcase"></i>
                        <span><?= $data['nav']['services'] ?></span>
                    </a>
                    <a class="col" href="#portfolio">
                        <i class="lni lni-pallet"></i>
                        <span><?= $data['nav']['portfolio'] ?></span>
                    </a>
                    <a class="col" href="#testimonials">
                        <i class="lni lni-quotation"></i>
                        <span><?= $data['nav']['testimonials'] ?></span>
                    </a>
                    <a class="col" href="#education">
                        <i class="lni lni-graduation"></i>
                        <span><?= $data['nav']['education'] ?></span>
                    </a>
                    <a class="col" href="#contact">
                        <i class="lni lni-envelope"></i>
                        <span><?= $data['nav']['contact'] ?></span>
                    </a>
                </div>
            </div>
        </div>
