!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            email: "Введите верный адрес email.",
            url: "Введите правильный URL.",
            date: "Введите правильную дату.",
            dateISO: "Введите правильную дату ( ISO ).",
            number: "Введите верное число.",
            digits: "Допустимы только цифры.",
            creditcard: "Введите верный номер банковской карты.",
            equalTo: "Введите то же самое значение еще раз.",
            maxlength: a.validator.format("Введите не больше, чем {0} символов."),
            minlength: a.validator.format("Введите как минимум {0} символов."),
            rangelength: a.validator.format("Введите значение от {0} до {1} символов."),
            range: a.validator.format("Введите значение от {0} да {1}."),
